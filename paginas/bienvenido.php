        ...
        <div id="id01" class="w3-modal">
            ...
            <div class="w3-modal-content w3-card-8 w3-animate-top" style="max-width:600px">
                ...
                <section class="card-solicitud">
                    ...
                    <h2>Solicitud.</h2>
                    <p>Nombre Completo del Visitante:
                        <?php echo $nombre_visita . ' ' . $apellido; ?>
                    </p>
                    <p>DPI:
                        <?php echo $dpi_visita; ?>
                    </p>
                    <p>Descripcion del Vehículo:
                        <?php echo $descripcion_visita; ?>
                    </p>
                    <p>Telefono:
                        <?php echo $telefono_visita; ?>
                    </p>
                    <p>Fecha de ingreso:
                        <?php echo $fecha_visita; ?>
                    </p>
                    <p>Motivo:
                        <?php echo $motivo_visita; ?>
                    </p>
                    <article>
                        <p>¿Qué deseas realizar con esta solicitud?</p>

                        <a
                            href="actualizar.php?codigo=<?php echo $codigo; ?>&id_detalle_visita=<?php echo $id_detalle_visita; ?> ">
                        ...
                        <a
                            href="denegar.php?codigo=<?php echo $codigo; ?>&id_detalle_visita=<?php echo $id_detalle_visita; ?> ">
                            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"
                                fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round"
